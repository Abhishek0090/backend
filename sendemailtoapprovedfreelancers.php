<?php
    ...
    function mailer1($id, $email, $firstname, $lastname)
    {
                            ...
                            <tr>
                                <td class="content-cell">
                                    <div class="f-fallback">
                                        ...
                                        <h1>Hey, '.$firstname.'</h1>
                                        <p>Happy New Year from the entire squad at BluePen! 🎉✨.
                                        <br><br>
                                        First off, major kudos to you for rocking it in 2023! Your enthusiasm didn\'t go unnoticed. Now, let\'s take that energy and turn it up a notch this year. 🚀 Whether you\'re conquering the academic jungle, chasing dreams, or simply enjoying the ride, we\'re here to cheer you on!
                                        <br><br>                                        
                                        Expect big things from us in 2024. We\'re cooking up some awesome projects, and a few surprises. Stay tuned because you\'re a crucial part of this journey!
                                        <br><br>
                                        Wishing you a year filled with success, laughter, and all-around awesomeness. Let\'s make 2024 the best one yet!
                                        <br><br>                                        
                                        Stay cool and stay winning,
                                        <br><br>
                                        Team BluePen 🌟
                                        </p>
                                        </div>
        ...
        $subject = "Cheers to a Stellar 2024 - 🚀 Let's Own It $firstname!";
        ...
        else
        {
            ...
            echo json_encode(array(
                'status' => 'success',
                'message' => 'Happy New Year to #'.$id.' - '.$firstname. ' '.$lastname,
                // 'error' => 'Error:' . curl_error($ch),
                // 'result' => $result,
            ));
        }

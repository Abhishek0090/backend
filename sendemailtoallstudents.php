<?php
    ...
    // get all email ids and names from table
    
    
    
    
    // loop function over all email ids and names
    
    $data_array = array();
    $get_data_sql = "SELECT * FROM `users` ORDER BY `id` DESC LIMIT 50 OFFSET 1180";
    ...
    function mailer1($id, $email, $firstname, $lastname)
    {
                            ...
                            <tr>
                                <td class="content-cell">
                                    <div class="f-fallback">
                                        ...
                                        <p>As the Diwali lights twinkle and the festive vibes roll in, we\'re buzzing with excitement to wish you and your squad a Diwali filled with academic triumphs and good times!
                                        <br><br>
                                        Let our services be the spark that lights up your academic path, guiding you to success like fairy lights leading the way. 🌟 As you dive into the festive spirit, we\'re here cheering you on for all those A+ moments!
                                        <br><br>
                                        May the coming year be your best chapter yet - full of victories and those lightbulb moments.
                                        <br><br>
                                        Happy Diwali from the whole crew at Bluepen!
                                        <br><br>
                                        Keep shining,
                                        Team Bluepen 📘✏🎉
                                        </p>
        ...
        $subject = "Shine Bright with Bluepen - Diwali Vibes! 🎓";

...
def register():
    ...
    if form.validate_on_submit():
        ...
        friendships = [Friendship(
            user_id=user.user_id, friend_id=u.user_id) for u in existing_users]
...
def recommend_events():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            print('IndexError=')
            return render_template('event-rs.html', form=form, absent='Invalid event name. Please try again.')
        distances = sorted(

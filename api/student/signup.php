<?php
    ...
    $affiliate_code_used = $data['affiliate_code'];
    ...
    else
    {
        ...
        VALUES ('$firstname', '$lastname', '$email', '0', '$country_name', '$country_code', '$number', '0', '$address', '$affiliate_code', 1, 'manual', '$password', '$affiliate_code_used', '$affiliate_user_id', 100, '$now', now(), '1', '$utm_data')";
        ...
        $password = $get_user_row['password'];
                        ...
                        <td class="email-body" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <div class="f-fallback">
                                    ...
                                    <p>Greetings from <strong>Bluepen</strong>! We are excited to welcome you to our platform, where academic support meets excellence. Your account has been successfully created, and you are now part of our community dedicated to assisting students in their educational journey.
                                        <br><br>To access your account, simply click on the button below and log in using your registered email address and the password you set during the registration process. If you ever forget your password, don\'t worry, we\'ve got you covered with a password reset option.

<?php
    ...
    else
    {
        ...
        $insert_user_sql = "INSERT INTO `users` (`firstname`, `lastname`, `email`, `email_verified`, `country_name`, `country_code`, `number`, `number_verified`, `address`, `is_accepted`, `signin_method`, `password`, `wallet`, `date_of_birth`, `created`, `agreed`)
        VALUES ('$firstname', '$lastname', '$email', '1', '$country_name', '$country_code', '$number', '1', '$address', 1, 'manual', '$password', 100, '$now', now(), '1')";

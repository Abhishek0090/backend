<?php
    ...
    $insert_into_update_table = "INSERT INTO `user_update` (`user_id`, `field`, `value`, `updated_on`) VALUES ('$user_id', 'firstname', '$old_first_name', '$now')";
    ...
    {
        $update_sql = "UPDATE `users` SET `firstname` = '$first_name' WHERE `id` = '$user_id'";

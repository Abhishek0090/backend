<?php
    ...
    if ($submit == "submit")
    {
        ...
        if($domain == "Art")
        {
            ...
            {
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[0], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[0]);
            }
            elseif($number_of_files == 3)
            {
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[0], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[0]);
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[1], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[1]);
            }
            elseif($number_of_files == 4)
            {
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[0], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[0]);
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[1], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[1]);
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[2], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[2]);
            }
            elseif($number_of_files == 5)
            {
                ...
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[1], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[1]);
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[2], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[2]);
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[3], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[3]);
            }
            elseif($number_of_files == 6)
            {
                ...
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[2], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[2]);
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[3], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[3]);
                rename("../../files/uploads/assignments/art_and_craft/".$assignment_files[4], "../../files/assignments/art_and_craft/".$assignment_id."_".$assignment_files[4]);
            }

            $insert_assignment_sql = "INSERT INTO `assignment_art` (`assignment_id`, `copy`, `city`, `title`, `project_category`, `instructions`, `budget`, `deadline`, `date_of_submission`, `file`, `is_active`, `posted`, `under_process`, `assigned_to_wm`, `assigned_to_writer`, `completed`, `review_received`, `lost`)
            VALUES ('$assignment_id', '$copy', '$city', '$title', '$project_category', '$instructions', '$budget', '$deadline', '$now', '$assignment_files_string', '1', 1, 0, 0, 0, 0, 0, 0)";

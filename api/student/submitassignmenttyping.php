<?php
    ...
    if ($submit == "submit")
    {
        ...
        $calculations_to_be_typed = $data['calculations_to_be_typed'];
        ...
        if($domain == "Typing")
        {
            ...
            {
                rename("../../files/uploads/assignments/typing/".$assignment_files[0], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[0]);
            }
            elseif($number_of_files == 3)
            {
                rename("../../files/uploads/assignments/typing/".$assignment_files[0], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[0]);
                rename("../../files/uploads/assignments/typing/".$assignment_files[1], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[1]);
            }
            elseif($number_of_files == 4)
            {
                rename("../../files/uploads/assignments/typing/".$assignment_files[0], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[0]);
                rename("../../files/uploads/assignments/typing/".$assignment_files[1], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[1]);
                rename("../../files/uploads/assignments/typing/".$assignment_files[2], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[2]);
            }
            elseif($number_of_files == 5)
            {
                ...
                rename("../../files/uploads/assignments/typing/".$assignment_files[1], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[1]);
                rename("../../files/uploads/assignments/typing/".$assignment_files[2], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[2]);
                rename("../../files/uploads/assignments/typing/".$assignment_files[3], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[3]);
            }
            elseif($number_of_files == 6)
            {
                ...
                rename("../../files/uploads/assignments/typing/".$assignment_files[2], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[2]);
                rename("../../files/uploads/assignments/typing/".$assignment_files[3], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[3]);
                rename("../../files/uploads/assignments/typing/".$assignment_files[4], "../../files/assignments/typing/".$assignment_id."_".$assignment_files[4]);
            }

            $insert_assignment_sql = "INSERT INTO `assignment_typing` (`assignment_id`, `city`, `copy`, `font`, `font_size`, `font_color`, `orientation`, `page_size`, `margins`, `number_of_pages`, `calculations`, `deadline_datetime`, `date_of_submission`, `budget`, `instructions`, `is_active`, `file`, `posted`, `under_process`, `assigned_to_wm`, `assigned_to_writer`, `completed`, `review_received`, `lost`)
            VALUES ('$assignment_id', '$city', '$copy', '$font', '$font_size', '$font_color', '$orientation', '$page_size', '$margins', '$number_of_pages', '$calculations_to_be_typed', '$deadline', '$now', '$budget', '$instructions',  '1', '$assignment_files_string', 1, 0, 0, 0, 0, 0, 0)";

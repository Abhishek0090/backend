<?php
    ...
    $old_budget = $get_details_row['budget'];

    date_default_timezone_set("Asia/Kolkata");
    $now = date("Y-m-d H:i:s", strtotime("now"));
    
    $insert_into_update_table = "INSERT INTO `assignment_update` (`assignment_id`, `field`, `value`, `updated_on`) VALUES ('$assignment_id', 'budget', '$old_budget', '$now')";
    ...
    {
        $update_sql = "UPDATE `assignment_freelance` SET `budget` = '$budget' WHERE `assignment_id` = '$assignment_id'";

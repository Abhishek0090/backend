<?php
    ...
    $freelancer_reward_claimsSql = "SELECT freelancer_reward_claims_old.`id`,freelancer_reward_claims_old.`freelancer_id`, freelancers_map.`firstname`,freelancers_map.`lastname`,freelancer_reward_claims_old.`number_of_assignments`,freelancer_reward_claims_old.`claim_datetime` , freelancer_reward_claims_old.`claimed` , freelancer_reward_claims_old.`sent` , freelancer_reward_claims_old.`received` FROM  `freelancer_reward_claims_old` JOIN `freelancers_map`ON `freelancers_map`.id = `freelancer_reward_claims_old`.freelancer_id ORDER BY freelancer_reward_claims_old.`id` DESC";

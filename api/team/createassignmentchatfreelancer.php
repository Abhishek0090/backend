<?php
    ...
    VALUES  ('Team and Freelancer Assignment', '$now', '$creator_role', '$created_by_id', '$members', '$assignment_id')";
    $insert_into_all_chats = mysqli_query($conn, $insert_into_all_chats_sql, 1);

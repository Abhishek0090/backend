<?php
    ...
    $insert_mail_sql = "INSERT INTO `assignment_mail_to_freelancer`
    (`assignment_id`, `freelancer_id`, `team_id`, `date_of_sending`, `title`, `body`) 
    VALUES ('$assignment_id', '$freelancer_id', '$team_id', '$now', '$title', '$body')";
    ...
    if($assign_to_freelancer_query)
    {
        ...
        mailer1($freelancer_mail, $freelancer_name, $assignment_id, $status, $title, $body);
        exit();
    }
    else
    {
    ...
    function mailer1($email,$freelancer_name,$assignment_id, $status, $title, $mail_body)
    {
        $to = $email;

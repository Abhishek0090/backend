    ...
    if (isset($_POST['submit']))
    {
        ...
        for( $i=0 ; $i < $profileimage ; $i++ )
        {
            ...
            if ($profiletarget != "")
            {
                ...
                $arr = str_replace("'", "", $arr);
                $profiletargetadmin = "../../files/uploads/assignments/plagiarism_checked/".$random_number.$new_name;
        ...
        $insert_file_data_into_sql = "INSERT INTO `uploaded_files_team`(`team_member_id`, `file_source`, `file_name`, `file_upload_date_time`)
        VALUES ('$team_member_id', 'plagiarism_assignment', '$arr', '$now')";

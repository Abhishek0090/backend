<?php
    ...
    if($type == "Text Message")
    {
        ...
        $get_message_id = "SELECT * FROM `team_and_student_chat` WHERE `chat_id` = '$chat_id' AND `sent_by_type` = '$sender_role' AND `sent_by_id` = '$sent_by_id' AND `type` = '$type' AND `message` = '$message' ORDER BY `id` DESC LIMIT 1";
    ...
    if($type == "File")
    {
        ...
        if($number_of_files == 2)
        {
            ...
            copy("../../files/chat/team_student_personal/".$u_id."_".$files[0], "../student/chat/team_student_personal/".$u_id."_".$files[0]);
        }
        elseif($number_of_files == 3)
        {
            ...
            copy("../../files/chat/team_student_personal/".$u_id."_".$files[1], "../student/chat/team_student_personal/".$u_id."_".$files[1]);
        }
        elseif($number_of_files == 4)
        {
            ...
            copy("../../files/chat/team_student_personal/".$u_id."_".$files[2], "../student/chat/team_student_personal/".$u_id."_".$files[2]);
        }
        elseif($number_of_files == 5)
        {
            ...
            copy("../../files/chat/team_student_personal/".$u_id."_".$files[3], "../student/chat/team_student_personal/".$u_id."_".$files[3]);
        }
        elseif($number_of_files == 6)
        {
            ...
            copy("../../files/chat/team_student_personal/".$u_id."_".$files[4], "../student/chat/team_student_personal/".$u_id."_".$files[4]);
        }
        elseif($number_of_files == 7)
        {
            ...
            copy("../../files/chat/team_student_personal/".$u_id."_".$files[5], "../student/chat/team_student_personal/".$u_id."_".$files[5]);
        }
        elseif($number_of_files == 8)
        {
            ...
            copy("../../files/chat/team_student_personal/".$u_id."_".$files[6], "../student/chat/team_student_personal/".$u_id."_".$files[6]);
        }
        elseif($number_of_files == 9)
        {
            ...
            copy("../../files/chat/team_student_personal/".$u_id."_".$files[7], "../student/chat/team_student_personal/".$u_id."_".$files[7]);
        }
        elseif($number_of_files == 10)
        {
            ...
            copy("../../files/chat/team_student_personal/".$u_id."_".$files[8], "../student/chat/team_student_personal/".$u_id."_".$files[8]);
        }
        elseif($number_of_files == 11)
        {
            ...
            copy("../../files/chat/team_student_personal/".$u_id."_".$files[9], "../student/chat/team_student_personal/".$u_id."_".$files[9]);
        }

<?php
    ...
    if($type == "Text Message")
    {
        ...
        $get_message_id = "SELECT * FROM `group_chat_assignment` WHERE `chat_id` = '$chat_id' AND `sent_by_type` = 'Freelancer' AND `sent_by_id` = '$sent_by_id' AND `type` = '$type' AND `message` = '$message' ORDER BY `id` DESC LIMIT 1";
    ...
    if($type == "File")
    {
        ...
        if($number_of_files == 2)
        {
            ...
            copy("../../files/chat/assignment_group/".$u_id."_".$files[0], "../team/chat/assignment_group/".$u_id."_".$files[0]);
        }
        elseif($number_of_files == 3)
        {
            ...
            copy("../../files/chat/assignment_group/".$u_id."_".$files[1], "../team/chat/assignment_group/".$u_id."_".$files[1]);
        }
        elseif($number_of_files == 4)
        {
            ...
            copy("../../files/chat/assignment_group/".$u_id."_".$files[2], "../team/chat/assignment_group/".$u_id."_".$files[2]);
        }
        elseif($number_of_files == 5)
        {
            ...
            copy("../../files/chat/assignment_group/".$u_id."_".$files[3], "../team/chat/assignment_group/".$u_id."_".$files[3]);
        }
        elseif($number_of_files == 6)
        {
            ...
            copy("../../files/chat/assignment_group/".$u_id."_".$files[4], "../team/chat/assignment_group/".$u_id."_".$files[4]);
        }
        elseif($number_of_files == 7)
        {
            ...
            copy("../../files/chat/assignment_group/".$u_id."_".$files[5], "../team/chat/assignment_group/".$u_id."_".$files[5]);
        }
        elseif($number_of_files == 8)
        {
            ...
            copy("../../files/chat/assignment_group/".$u_id."_".$files[6], "../team/chat/assignment_group/".$u_id."_".$files[6]);
        }
        elseif($number_of_files == 9)
        {
            ...
            copy("../../files/chat/assignment_group/".$u_id."_".$files[7], "../team/chat/assignment_group/".$u_id."_".$files[7]);
        }
        elseif($number_of_files == 10)
        {
            ...
            copy("../../files/chat/assignment_group/".$u_id."_".$files[8], "../team/chat/assignment_group/".$u_id."_".$files[8]);
        }
        elseif($number_of_files == 11)
        {
            ...
            copy("../../files/chat/assignment_group/".$u_id."_".$files[9], "../team/chat/assignment_group/".$u_id."_".$files[9]);
        }

<?php
    ...
    $insert_into_update_table = "INSERT INTO `freelancer_update` (`freelancer_id`, `field`, `value`, `updated_on`) VALUES ('$freelancer_id', 'address', '$old_address', '$now')";
    ...
    {
        $update_sql = "UPDATE `freelancers_map` SET `address` = '$address' WHERE `id` = '$freelancer_id'";

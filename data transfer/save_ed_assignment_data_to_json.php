<?php
    ...
    $get_all_assignments_from_old_database = "SELECT * FROM `assignmentsed`";
    ...
    while ($get_all_assignments_from_old_database_row = mysqli_fetch_array($get_all_assignments_from_old_database_result))
    {
        $assignment_array = array (
            ...
            'software' => $get_all_assignments_from_old_database_row['software'],
    ...
    $fp = fopen('ed_assignment_data.json', 'w');

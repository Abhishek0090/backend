<?php
    ...
    if(file_exists($filename))
    {
        ...
        for($i = 0; $i < $number_of_arrays; $i++)
        {
            ...
            $insert_assignment_sql = "INSERT INTO `users` (`id`, `firstname`, `lastname`, `college`, `email`, `email_verified`, `country_name`, `number`, `number_verified`, `address`, `is_accepted`, `signin_method`, `password`, `wallet`, `date_of_birth`, `created`, `agreed`) 
